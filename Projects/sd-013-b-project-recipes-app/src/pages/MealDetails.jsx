  ...
  return (
    <div>
      { meals && meals.map((recipeSelected) => (
        <div className="body-recipe-details" key={ recipeSelected.idMeal }>
          <img
            id="recipe-image"
          ...
          <div className="recipe-title-card">
            <h1 className="recipe-name" data-testid="recipe-title">
              { recipeSelected.strMeal }
            </h1>
            <input
          ...
          <div className="info-recipes">
            ...
            >
              { recipeSelected.strInstructions }
            </p>
          </div>
      ...
      <h2 className="title">Recomendadas</h2>
